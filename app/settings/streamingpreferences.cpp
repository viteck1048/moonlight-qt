...
#define SER_POINTERREGIONLOCK "pointerregionlock"
#define SER_USERCOMBOSENABLED "usercombosenabled"
...
void StreamingPreferences::reload()
{
    ...
    pointerRegionLockActive = settings.value(SER_POINTERREGIONLOCK, false).toBool();
    userCombosEnabled = settings.value(SER_USERCOMBOSENABLED, false).toBool();
...
void StreamingPreferences::save()
{
    ...
    settings.setValue(SER_POINTERREGIONLOCK, pointerRegionLockActive);
    settings.setValue(SER_USERCOMBOSENABLED, userCombosEnabled);
